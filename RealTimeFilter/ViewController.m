...
- (void)setFilter_name:(NSString *)filter_name
{
    _filter_name = filter_name;
}

- (NSString *)getFilter_name
{
    return _filter_name;
}
...
{
    [self setFilter_name:@"CIComicEffect"];
    ...
    CIFilter *effectFilter = [CIFilter filterWithName:[self getFilter_name]];
